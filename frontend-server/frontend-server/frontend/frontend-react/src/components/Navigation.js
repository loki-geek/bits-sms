  ...
  return (
    <div>
      <Navbar id="my-nav" fixedTop
	    ...
	    <a href="https://bitssms-login.auth.ap-south-1.amazoncognito.com/logout?client_id=14ob3e7e7mfnmvq3v687g1ls3o&logout_uri=https://www.bitssms.xyz"><button class="logout">Logout</button></a>
          </div>
        </Navbar.Brand>
      </Navbar>
